...
final class TwitterClient: BDBOAuth1SessionManager {
    ...
    static let sharedInstance = TwitterClient(
        ...
        consumerKey: "1TMiwbmhJXq1ahQNyjW0hfDOT",
        consumerSecret: "48ny722IZLvz3Ib3w8qbKyBHOB8t7fhd8YdUAqE655KYYIRV9P"
    )
    ...
    func login(success: () -> (), failure: (NSError) -> ()) {
        ...
        deauthorize()
        fetchRequestTokenWithPath("oauth/request_token", method: "GET", callbackURL: NSURL(string: "meenatwitterapp://oauth")!, scope: nil, success: { (requestToken: BDBOAuth1Credential!) -> Void in
    ...
    func populatePreviousTweets(tweet: Tweet, completion: (()->())? = nil) {
        ...
        guard tweet.precedingTweetID != nil else {
            self.buffer = nil
            self.bufferComplete?()
            return
        }
